...
public class BytesTool
{
     ...
     * @param buf
     * @param offset
     * @param atLeast 至少读取的字节数
     * @param in
     * @return
     * @throws IOException
     */
    public static int readAtLeast(byte[] buf, int offset, int atLeast, InputStream in) throws IOException
    {
        int n, current = 0;
        while (atLeast > 0)
        {
    ...
    {
//        char[] cs = new char[2 * length];
//        length += offset;
//        for (int i = offset, j = 0; i < length; i++) {
//            String str = Integer.toHexString(0xff & bs[i]);
//            if (str.length() == 1) {
//                cs[j++] = '0';
//                cs[j++] = str.charAt(0);
//            } else {
...
//        return new String(cs);
     ...
     * @return
     */
    public static short readUnShort(byte[] data, int offset)
    {
